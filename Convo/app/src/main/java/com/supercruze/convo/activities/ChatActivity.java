...
import com.supercruze.convo.adapters.ChatAdapter;
import com.supercruze.convo.databinding.ActivityChatBinding;
import com.supercruze.convo.models.ChatMessage;
import com.supercruze.convo.models.User;
import com.supercruze.convo.network.ApiClient;
import com.supercruze.convo.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private String conversatioinId = null;
    ...
    private void setListners() {
        ...
        return new SimpleDateFormat("dd MMMM,yyy - hh:mm a", Locale.getDefault()).format(date);
        }

        private void addConversation(HashMap<String,Object> conversation){
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
                .add(conversation)
                .addOnSuccessListener(documentReference -> conversatioinId = documentReference.getId());
        }


        private void updateConversations(String message){
            DocumentReference documentReference = database.collection(
                    Constants.KEY_COLLECTION_CONVERSATIONS).document(conversatioinId);
        ...
        private final OnCompleteListener<QuerySnapshot> conversationOnCompleteListener = task -> {
            if(task.isSuccessful() && task.getResult() != null && task.getResult().getDocuments().size()>0){
                ...
                conversatioinId = documentSnapshot.getId();
